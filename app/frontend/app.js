function studio() {
  return {
    ...
    async saveAutoUpdate() {
      ...
      try {
        const r=await fetch(`${this.apiBase}/api/auto-update/settings`,{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(this.autoUpdate.settings)});
